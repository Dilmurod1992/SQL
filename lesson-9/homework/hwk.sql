...
select P.ProductName, P.Price, P.Category, S.SupplierName  from Products as P
...
select C.FirstName, C.LastName, O.OrderID, O.TotalAmount, C.CustomerID from Customers as C
...
select emp.Name, dep.DepartmentName from Departments as dep
...
select s.Name, en.CourseID, s.Major from Students as s
...
select p.ProductName, p.Price, o.OrderID from Products as p
inner join Orders as o
...
select o.OrderID, o.Quantity, p.ProductName, p.StockQuantity from Orders as o
inner join Products as p
...
select s.SaleID, c.FirstName, c.Country from Sales as s
join Customers as c
...
select o.OrderID, o.TotalAmount, c.FirstName, c.Country from Orders as o
...
select pay.PaymentID, pay.Amount, o.OrderID, o.Quantity, p.ProductName, p.Price from Payments as pay
inner join Orders as o
...
select emp1.Name, emp1.Salary, emp2.Name, emp2.Salary from Employees as emp1
...
select c.FirstName, o.OrderID, p.PaymentID from Customers as c
left join Orders as o
on c.CustomerID=o.CustomerID
left join Payments as p
on o.OrderID=p.OrderID
where o.OrderID is not null and p.PaymentID is null
